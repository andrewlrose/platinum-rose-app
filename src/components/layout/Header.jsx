    ...
    <header className="bg-slate-900 border-b border-slate-800 sticky top-0 z-40 shadow-2xl shadow-black/20 flex flex-col">
      ...
      <div className="relative container mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 z-10">
            <button onClick={onSaveFile} className="flex items-center gap-2 px-4 py-2 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-500 border border-emerald-500/20 rounded-lg font-bold text-xs transition-all">
              <Save size={18} /> <span className="hidden lg:inline">SAVE</span>
            </button>
            <button onClick={() => fileInputRef.current.click()} className="flex items-center gap-2 px-4 py-2 bg-blue-500/10 hover:bg-blue-500/20 text-blue-500 border border-blue-500/20 rounded-lg font-bold text-xs transition-all">
            ...
            <button onClick={onReset} className="p-3 text-slate-500 hover:text-rose-500 hover:bg-rose-500/10 rounded-xl transition-colors">
              <Trash2 size={20} />
            </button>
        </div>
      </div>
