...
// 🔥 UPDATED IMPORTS: Added CheckCircle and AlertTriangle
import { TrendingUp, Activity, Trophy, ExternalLink, List, Calculator, Cloud, Sun, Umbrella, Snowflake, Wind, ChevronRight, X, Thermometer, Split, User, CheckCircle, AlertTriangle } from 'lucide-react';
...
const getAbbr = (name) => {
    if (!name) return "UNK";
    const map = { "Packers": "GB", "Bears": "CHI", "Vikings": "MIN", "Lions": "DET", "Cowboys": "DAL", "Eagles": "PHI", "Giants": "NYG", "Commanders": "WAS", "Washington": "WAS", "Buccaneers": "TB", "Saints": "NO", "Panthers": "CAR", "Falcons": "ATL", "Seahawks": "SEA", "49ers": "SF", "Rams": "LAR", "Cardinals": "ARI", "Chiefs": "KC", "Chargers": "LAC", "Raiders": "LV", "Broncos": "DEN", "Ravens": "BAL", "Steelers": "PIT", "Bengals": "CIN", "Browns": "CLE", "Bills": "BUF", "Dolphins": "MIA", "Patriots": "NE", "Jets": "NYJ", "Texans": "HOU", "Colts": "IND", "Jaguars": "JAX", "Titans": "TEN" };
